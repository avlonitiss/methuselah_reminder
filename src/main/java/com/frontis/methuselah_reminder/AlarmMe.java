...
//    mAlarmListAdapter.save();
  ...
  public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo)
  {
    if (v.getId() == R.id.alarm_list)
    {
      ...
      menu.add(Menu.NONE, CONTEXT_MENU_EDIT, Menu.NONE, "Διόρθωση");
      menu.add(Menu.NONE, CONTEXT_MENU_DELETE, Menu.NONE, "Διαγραφή");
      menu.add(Menu.NONE, CONTEXT_MENU_DUPLICATE, Menu.NONE, "Αντιγραφή");
    }
  }
